...
class Auth extends ShieldAuth
{
     ...
     */
    public array $views = [
        'accessadmin'                       => '\CodeIgniter\Shield\Views\login',
     ...
     * 3. A URI path within the application. e.g 'admin', 'accessadmin', 'expath'
     *
    ...
    {
        $session = session();
        $url     = $session->getTempdata('beforeLoginUrl') ?? setting('Auth.redirects')['accessadmin'];
