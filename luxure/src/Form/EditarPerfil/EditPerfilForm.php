...
namespace App\Form\EditarPerfil;
...
class EditPerfilForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('arq_1', FileType::class, [
                ...
                'required' => false,
                'attr' => [
                    'accept' => 'image/jpeg, image/png, image/heic, video/mp4, video/webm, video/quicktime',
                    'class' => 'upload-field'
                ],
                'constraints' => [
                    new File([
            ...
            ->add('arqs_removidos', HiddenType::class, [
                'attr' => ['id' => 'arq_rem']
            ])
